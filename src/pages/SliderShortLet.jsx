...
class SliderShortLet extends Component  {
  ...
  // execute the code 
  componentDidMount() {
    fetch("http://localhost:2020/property/top1/ShortLet/Short-Let")
        .then((res) => res.json())
        .then((json) => {
  ...
  render() {
    ...
    return ( 
       <div  className="sliderShortLet-second-lay">

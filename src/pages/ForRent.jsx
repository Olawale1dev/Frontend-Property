...
import {Link, useLocation, useParams, unstable_HistoryRouter} from 'react-router-dom';
...
class ForRent extends Component  {
 ...
 onePageFirst = () => {
  ...
  findLastPage(){
   let condition = Math.floor(this.state.totalElements / this.state.itemsPerPage) ;
  ...
  nextPage = () => {
    ...
    if(this.state.currentPage < Math.floor(this.state.totalElements / this.state.itemsPerPage) ){
      if (this.state.search){
  ...
  render() {
    const {items,onePerPage,  currentPage,onePageFirst, propertyId, totalPages,type,  DataisLoaded, search, PropertyLoaded ,bedroomNo,  area, price} = this.state;
      ...
      <div class="property-first-layer">
        ...
        <div className="ContainerSection">
            <div size="sm" className="searchSection">
                ...
                <TextField type="text"  color="secondary" name="area" focused  
                    value={area}
                ...
                <InputLabel id="demo-simple-select-autowidth-label">Search By Bedroom Number</InputLabel>
                  ...
                  <TextField type="text"  color="secondary" name="price" focused  
                    value={price}
                      ...
                      <div key={property.id} 
                       >
                        ...
                        <br></br>
                          ...
                          <Button type="number" className="pageNumCss"  name="onePage" value={property.id} 
                            onClick={this.onePage} onChange={propertyId}>More</Button>
